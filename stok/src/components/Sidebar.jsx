...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`
        w-64 h-screen sticky top-0 z-20 transition-all duration-500
      ...
      <div className="flex flex-col h-full justify-between relative z-10">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          >
            ...
            <div className="ml-4">
              <h1 className="text-xl font-bold text-[#215ba6] dark:text-white tracking-wide leading-tight transition-all duration-500">
              ...
              <p className="font-normal text-sm text-gray-600 dark:text-gray-300 mt-1 transition-all duration-500">
                IT Asset Management
              </p>
            </div>
          </div>
          ...
          {/* Menu Navigation */}
          <nav className="mt-4 flex-1 flex flex-col space-y-2 px-3 overflow-y-auto pb-4">
            {/* Dashboard */}
            <NavLink
              to="/"
              className={({ isActive }) =>
                ...
                " flex items-center px-6 py-3 text-base font-medium rounded-xl transition-all duration-300 mx-1 group relative overflow-hidden"
              }
            >
              {/* Hover effect */}
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              
              <BsHouse className="mr-4 group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors duration-300 relative z-10" /> 
              ...
              {/* Active indicator */}
              <div className="absolute right-3 w-2 h-2 bg-blue-500 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            </NavLink>
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              <BsLaptop className="mr-4 group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors duration-300 relative z-10" /> 
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              <BsKeyboard className="mr-4 group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors duration-300 relative z-10" /> 
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              <BsKey className="mr-4 group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors duration-300 relative z-10" /> 
            ...
            <div className="mx-1">
              <button
                className={
                  "flex items-center px-6 py-3 text-base font-medium rounded-xl transition-all duration-300 w-full group relative overflow-hidden " +
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <BsHeadset className="mr-4 group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors duration-300 relative z-10" />
                ...
                {helpdeskOpen ? (
                  <BsChevronUp className="ml-auto transition-transform duration-300 group-hover:text-blue-600 dark:group-hover:text-blue-300 relative z-10" />
                ) : (
                  <BsChevronDown className="ml-auto transition-transform duration-300 group-hover:text-blue-600 dark:group-hover:text-blue-300 relative z-10" />
                )}
              </button>
              {helpdeskOpen && (
                <div className="ml-6 mt-2 flex flex-col space-y-2 border-l-2 border-blue-200 dark:border-blue-700 pl-4 animate-fadeIn">
                  <NavLink
                    to="/helpdesk/entry"
                    className={({ isActive }) =>
                      (isActive
                      ...
                      " px-4 py-2 text-sm rounded-lg transition-all duration-300 transform hover:translate-x-1 flex items-center"
                    }
                  >
            ...
            <div className="mx-1">
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <BsBarChart className="mr-4 group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors duration-300 relative z-10" />
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              <BsGear className="mr-4 group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors duration-300 relative z-10" /> 
        ...
        <div className="p-4 pb-6 border-t border-blue-100/50 dark:border-gray-700/50 mt-auto bg-white/30 dark:bg-gray-800/30 backdrop-blur-sm">
          {/* User Info */}
          <div 
            className="flex items-center mb-4 p-3 rounded-xl bg-white/80 dark:bg-gray-800/80 shadow-sm transition-all duration-300 hover:shadow-md cursor-pointer border border-blue-100/30 dark:border-gray-700/30"
            onClick={toggleUserMenu}
            onMouseEnter={() => setActiveHover('user')}
            onMouseLeave={() => setActiveHover(null)}
          >
            <div className="relative">
              <div className={`absolute -inset-2 bg-blue-200/30 dark:bg-blue-800/30 rounded-full blur transition-all duration-300 ${
                activeHover === 'user' ? 'opacity-100 scale-110' : 'opacity-0 scale-100'
              }`}></div>
              <BsPersonCircle className="text-gray-600 dark:text-gray-300 text-xl mr-3 transition-colors duration-300 relative z-10" 
                style={{ color: activeHover === 'user' ? '#2563eb' : '' }} />
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-gray-800 dark:text-white truncate transition-colors duration-300"
                 style={{ color: activeHover === 'user' ? '#2563eb' : '' }}>
                {user.name || "User"}
              </p>
          ...
          {/* User Menu Dropdown */}
          {userMenuOpen && (
            <div className="mb-4 p-3 rounded-xl bg-white/90 dark:bg-gray-800/90 shadow-lg animate-fadeIn border border-blue-100/30 dark:border-gray-700/30 backdrop-blur-sm">
              <button
                onClick={() => navigate("/profile")}
                className="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-gray-700 rounded-lg transition-all duration-300 flex items-center transform hover:translate-x-1"
              >
              ...
              <button
                ...
                className="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-gray-700 rounded-lg transition-all duration-300 flex items-center transform hover:translate-x-1 mt-2"
              >
          ...
          {/* Dark Mode Toggle */}
          <div className="flex items-center justify-between mb-4 p-3 rounded-xl bg-white/80 dark:bg-gray-800/80 shadow-sm transition-all duration-300 hover:shadow-md border border-blue-100/30 dark:border-gray-700/30">
            <div className="flex items-center">
              {dark ? (
                <FaRegSun className="text-yellow-500 mr-3 transition-colors duration-300" />
              ) : (
                <FaRegMoon className="text-gray-600 mr-3 transition-colors duration-300" />
              )}
          ...
          <button
            ...
            onMouseLeave={() => setActiveHover(null)}
          >
            <BsBoxArrowRight className="mr-2 transition-transform duration-300" 
